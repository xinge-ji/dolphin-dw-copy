...
-- 添加索引优化查询性能
CREATE INDEX IF NOT EXISTS idx_startdates ON dim.goods_set (dw_starttime);
CREATE INDEX IF NOT EXISTS idx_enddates ON dim.goods_set (dw_endtime);
CREATE INDEX IF NOT EXISTS idx_active ON dim.goods_set (is_active);