drop table if exists dwd.wholesale_sales_ar_detail;
create table dwd.wholesale_sales_ar_detail (
    -- 颗粒度
...
CREATE INDEX IF NOT EXISTS idx_salesid ON dwd.wholesale_sales_ar_detail (salesid);
CREATE INDEX IF NOT EXISTS idx_salesdtlid ON dwd.wholesale_sales_ar_detail (salesdtlid);
CREATE INDEX IF NOT EXISTS idx_entryid ON dwd.wholesale_sales_ar_detail (entryid);
CREATE INDEX IF NOT EXISTS idx_customid ON dwd.wholesale_sales_ar_detail (customid);
CREATE INDEX IF NOT EXISTS idx_create_date ON dwd.wholesale_sales_ar_detail (create_date);
CREATE INDEX IF NOT EXISTS idx_order_settle_time ON dwd.wholesale_sales_ar_detail (order_settle_time);
CREATE INDEX IF NOT EXISTS idx_order_settle_status ON dwd.wholesale_sales_ar_detail (order_settle_status);
CREATE INDEX IF NOT EXISTS idx_order_payment_time ON dwd.wholesale_sales_ar_detail (order_payment_time);
CREATE INDEX IF NOT EXISTS idx_order_payment_status ON dwd.wholesale_sales_ar_detail (order_payment_status);
