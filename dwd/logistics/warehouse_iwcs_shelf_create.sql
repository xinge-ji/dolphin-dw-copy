DROP TABLE IF EXISTS dwd.logistics_warehouse_iwcs_shelf;

CREATE TABLE
    dwd.logistics_warehouse_iwcs_shelf (
        ssc_receive_goods_locate_id decimal(38, 0) not null COMMENT '收货商品定位ID',
        receive_bill_type varchar COMMENT '收货单类型',
        com_inv_case_id decimal COMMENT '公司库存箱ID',
        stock_pos_id decimal COMMENT '库存位置ID',
        create_time DATETIME COMMENT '创建时间',
        goodsownerid decimal(38, 18) COMMENT '货主ID',
        goodsowner_name varchar COMMENT '货主名称',
        companyid decimal(38, 18) COMMENT '公司ID',
        company_name varchar COMMENT '公司名称',
        indtlid decimal(38, 18) COMMENT '入库明细ID',
        receiveid decimal(38, 18) COMMENT '收货ID',
        scanerid decimal COMMENT '扫描员ID',
        scaner_name varchar COMMENT '扫描员姓名',
        ownergoodsid decimal COMMENT '货主商品ID',
        goods_name varchar COMMENT '商品名称',
        goods_eng_name varchar COMMENT '商品英文名称',
        ...
        lotid decimal COMMENT '批次ID',
        lotno varchar COMMENT '批次号',
        ownerpackid decimal(38, 18) COMMENT '货主包装ID',
        pack_name varchar COMMENT '包装名称',
        pack_size decimal(31, 8) COMMENT '包装规格',
