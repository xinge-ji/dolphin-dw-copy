...
WITH
    ...
    base_data_receive_check AS (
        ...
        WHERE is_autotask = 0 
            ...
            AND DATE_TRUNC(check_time, 'MONTH') >= DATE_SUB(DATE_TRUNC(CURRENT_DATE(), 'MONTH'), INTERVAL 2 MONTH)
    ...
    base_data_check_flat AS (
        ...
        WHERE is_autotask = 0 
            ...
            AND DATE_TRUNC(finish_time, 'MONTH') >= DATE_SUB(DATE_TRUNC(CURRENT_DATE(), 'MONTH'), INTERVAL 2 MONTH)
    ...
    base_data_check_auto AS (
        ...
        WHERE is_autotask = 0 
            ...
            AND DATE_TRUNC(iwcs_finish_time, 'MONTH') >= DATE_SUB(DATE_TRUNC(CURRENT_DATE(), 'MONTH'), INTERVAL 2 MONTH)
