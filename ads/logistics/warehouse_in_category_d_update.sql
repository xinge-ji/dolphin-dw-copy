INSERT INTO
    ads.logistics_warehouse_in_category_d (
        stat_date,
        warehid,
        category,
        warehouse_name,
...
WITH
    ...
    base_data_receive_check AS (
        ...
        SELECT DISTINCT
            ...
            DATE_TRUNC(check_time, 'DAY') as stat_date,
            inid,
            indtlid,
            receiveid,
        ...
        WHERE is_autotask = 0 
            ...
            AND DATE_TRUNC(check_time, 'DAY') >= DATE_SUB(DATE_TRUNC(CURRENT_DATE(), 'DAY'), INTERVAL 2 MONTH)
        ...
        SELECT DISTINCT
            ...
            warehouse_name,
            '所有' as category,
            DATE_TRUNC(check_time, 'DATE') as stat_date,
            inid,
            indtlid,
            receiveid,
            time_receive_to_check / 60.0 as time_receive_to_check_hours,
        ...
        WHERE is_autotask = 0 
            AND receiveid IS NOT NULL 
            AND time_receive_to_check IS NOT NULL
            AND DATE_TRUNC(check_time, 'DATE') >= DATE_SUB(DATE_TRUNC(CURRENT_DATE(), 'DATE'), INTERVAL 2 MONTH)
    ),
    base_data_check_flat AS (
        ...
        SELECT DISTINCT
            ...
            warehouse_name,
            goods_category as category,
            DATE_TRUNC(finish_time, 'DATE') as stat_date,
            inid,
            indtlid,
            receiveid,
            inoutid,
        ...
        WHERE is_autotask = 0 
            ...
            AND DATE_TRUNC(finish_time, 'DATE') >= DATE_SUB(DATE_TRUNC(CURRENT_DATE(), 'DATE'), INTERVAL 2 MONTH)
    ...
    base_data_check_auto AS (
        ...
        SELECT DISTINCT
            ...
            warehouse_name,
            goods_category as category,
            DATE_TRUNC(iwcs_finish_time, 'DATE') as stat_date,
            inid,
            indtlid,
            receiveid,
        ...
        WHERE is_autotask = 0 
            ...
            AND DATE_TRUNC(iwcs_finish_time, 'DATE') >= DATE_SUB(DATE_TRUNC(CURRENT_DATE(), 'DATE'), INTERVAL 2 MONTH)
