...
SELECT
    ...
    goodsid,
    entryid,
    IFNULL(entry_name, 'UNKNOWN') as entry_name,
    IFNULL(province_name, 'UNKNOWN') as province_name,
    IFNULL(city_name, 'UNKNOWN') as city_name,
    IFNULL(area_name, 'UNKNOWN') as area_name,
    IFNULL(caiwu_level1, 'UNKNOWN') as caiwu_level1,
    IFNULL(caiwu_level2, 'UNKNOWN') as caiwu_level2,
    customid,
    IFNULL(customer_name, 'UNKNOWN') as customer_name,
    IFNULL(customertype_name, 'UNKNOWN') as customertype_name,
    IFNULL(customertype_group, 'UNKNOWN') as customertype_group,
    IFNULL(customer_financeclass_name, 'UNKNOWN') as customer_financeclass_name,
    IFNULL(is_jicai_zhongxuan, 0) as is_jicai_zhongxuan,
    ...
    IFNULL(group_manage_type, 'UNKNOWN') as group_manage_type,
