drop table if exists dws.wholesale_sales_receivable_aging_d;

-- 创建应收账款和账龄分析表结构
create table dws.wholesale_sales_receivable_aging_d (
    stat_date date COMMENT '统计日期',
    entryid varchar(255) COMMENT '独立单元ID',
    customid varchar(255) COMMENT '客户ID',
...
UNIQUE KEY(stat_date,entryid,customid) DISTRIBUTED BY HASH(stat_date,entryid,customid) PROPERTIES (
